...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>↪️ Requested: {search}</b>\n<b>👤 Requested By: {mention}</b>\n<b>📤 Uploaded To: Movie Hub Server</b>\n<b>🧑‍🔧 Get Support ✔️ <a href="https://t.me/hellodragan">TG Dragon</a></b>\n\n📌 Press The Down Buttons To Access The File\n<b><s>📌 This Post Will Be Deleted After 10 Minutes</b></s>"
